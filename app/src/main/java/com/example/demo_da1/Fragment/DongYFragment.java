...
public class DongYFragment extends Fragment {
...
//
    ...
    public void Init(){
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new MyTask().execute("https://vtv.vn/suc-khoe/dong-y.rss");
            }
        });
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_dong_y, container, false);
        Init();
        return view;
    }
    @Override
